#ifndef DK_OPENGL_GLTYPES_HPP
#define DK_OPENGL_GLTYPES_HPP
...
inline namespace types {
    ...
    // NOLINTNEXTLINE
    inline std::bitset<32> to_bitset(bitfield field) { return { field }; }
...
enum32 enum_cast(T enum_value) {
    return static_cast<enum32>(enum_value);
}

} // namespace dk::gl
#endif // DK_OPENGL_GLTYPES_HPP
