...
public:
    MeshWithIndicesApplication()
        ...
        const std::string path_prefix = "src/mesh_with_indices/";
        program
        ...
        meshes.reserve(4);
        spdlog::info("loading Cube");
        meshes.emplace_back(
            dk::file::obj::experimental::read<dk::gl::experimental::Vertex>(
                "assets/obj_files/cube.obj"
            )
        );
        spdlog::info("loading cone");
        // TODO:
        // add something that is going to work like this:
        // dk::assets("cone.obj")
        // it is going to find cone.obj by searching first some context-global
        // assets folder and then look into pre-determined locations.
        // dk::source("some-cool.shader.glsl")
        // would be cool too.
        // These two would read some provided singleton structure? Or something
        // more sofisticated, like subsystem, or something like that. That
        // would be tied to this Application instance.
        meshes.emplace_back(
            dk::file::obj::experimental::read<dk::gl::experimental::Vertex>(
                "assets/obj_files/cone.obj"
            )
        );
        spdlog::info("loading monkey");
        meshes.emplace_back(
            dk::file::obj::experimental::read<dk::gl::experimental::Vertex>(
        ...
        // meshes.emplace_back(dk::ObjFile::read("assets/obj_files/cube.obj"));
        // meshes.emplace_back(dk::ObjFile::read("assets/obj_files/cone.obj"));
        // meshes.emplace_back(dk::ObjFile::read("assets/obj_files/monkey.obj"));
        // meshes.emplace_back(dk::ObjFile::read("assets/obj_files/bunny.obj"));
