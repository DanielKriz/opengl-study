...
namespace dk {
class SimpleCubeApplication : public dk::gl::Application {
public:
    SimpleCubeApplication();
    virtual ~SimpleCubeApplication();

    void init() override {};
    void startup() override {};
    void render(double delta) override {
        static const gl::f32 vertex_data[] = {
        ...
        static const gl::f32 color_data[] = {
        ...
        // gl::draw(gl::DrawMode::TRIANGLES, 0, 12 * 3);
    };
